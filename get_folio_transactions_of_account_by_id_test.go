...
func TestGetFolioTransactionsOfAccountByID(t *testing.T) {
	client := client()

	req := client.NewGetFolioTransactionsOfAccountByIDRequest()
...
func TestGetFolioTransactionsOfAccountByIDAll(t *testing.T) {
	client := client()
